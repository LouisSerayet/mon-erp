...
export const L = {
  fr: {
    ...
    coordonneesBancaires: 'Coordonnées bancaires',
    banqueLabel: 'Banque : ',
    ibanLabel: 'IBAN : ',
    bicLabel: 'BIC : ',
    tel: 'Tél : ',
    ...
    syntheseLots: 'SYNTHÈSE DES LOTS',
    syntheseLotsNote: 'Détail de chaque lot en pages suivantes.',
    colCategorie: 'Catégorie',
    colPart: 'Part du total',
    horsLot: 'Hors lot',
  ...
  en: {
    ...
    coordonneesBancaires: 'Bank details',
    banqueLabel: 'Bank: ',
    ibanLabel: 'IBAN: ',
    bicLabel: 'BIC: ',
    tel: 'Phone: ',
    ...
    syntheseLots: 'SECTION SUMMARY',
    syntheseLotsNote: 'Detail for each section on the following pages.',
    colCategorie: 'Category',
    colPart: 'Share of total',
    horsLot: 'Ungrouped',
